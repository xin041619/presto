 ...
 */
@ThreadSafe
public class KafkaRebindSafeMBeanServer
        implements MBeanServer
{
    private static final Logger log = Logger.get(KafkaRebindSafeMBeanServer.class);

    private final MBeanServer mbeanServer;

    public KafkaRebindSafeMBeanServer(MBeanServer mbeanServer)
    {
